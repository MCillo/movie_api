...
let allowedOrigins = ['http://localhost:8080', 'http://testsite.com', 'http://localhost:1234', 'https://myflixapp-765.herokuapp.com', 'https://myflix765.netlify.app']; // restricts access to only the included origin domains
app.use(cors({
